...
• *Kebijakan Privasi:*
1. ʏᴀɴꜱ ʙᴏᴛᴢ tidak akan merekam data riwayat chat user.
2. ʏᴀɴꜱ ʙᴏᴛᴢ tidak akan menyebarkan nomor users.
3. ʏᴀɴꜱ ʙᴏᴛᴢ tidak akan menyimpan media yang dikirimkan oleh users.
4. ʏᴀɴꜱ ʙᴏᴛᴢ tidak akan menyalah gunakan data data users.
5. Owner ʏᴀɴꜱ ʙᴏᴛᴢ berhak melihat data riwayat chat users.
6. Owner ʏᴀɴꜱ ʙᴏᴛᴢ berhak melihat status users.
7. Owner ʏᴀɴꜱ ʙᴏᴛᴢ dapat melihat riwayat chat, dan media yang dikirimkan users.

• Jika ada bug/eror di website kami saya mohon untuk Report nya, tanpa biaya dan aman

_Cara penggunaan ʏᴀɴꜱ ʙᴏᴛᴢ Agar terhindar dari Suspand_
...
• *Syarat Ketentuan ʏᴀɴꜱ ʙᴏᴛᴢ:*

1. ʏᴀɴꜱ ʙᴏᴛᴢ akan keluar dari group jika ada salah satu member melanggar peraturan.
2. ʏᴀɴꜱ ʙᴏᴛᴢ dapat mem-ban users secara sepihak terlepas dari users salah atau tidak.
3. ʏᴀɴꜱ ʙᴏᴛᴢ tidak akan bertanggungjawab atas apapun yang users lakukan terhadap fitur bot.
4. ʏᴀɴꜱ ʙᴏᴛᴢ akan memberlakukan hukuman: block atau ban terhadap users yang melanggar peraturan.
5. ʏᴀɴꜱ ʙᴏᴛᴢ bertanggung jawab atas kesalahan fatal dalam programing maupun owner.
❏┳━━◩
┍┛
┆⟥⟤ ➠ ${global.bottime}
└─┈⟅
